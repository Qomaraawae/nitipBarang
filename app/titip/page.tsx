    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-8 px-4">
          ...
          <div>
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
              ...
              <div className="p-4 sm:p-6 md:p-8">
                {/* Legend */}
                <div className="flex flex-wrap gap-3 sm:gap-4 mb-6 pb-6 border-b border-gray-200">
                  <div className="flex items-center space-x-2">
                    <div className="w-6 h-6 sm:w-8 sm:h-8 bg-white border-2 border-gray-300 rounded-lg"></div>
                    <span className="text-xs sm:text-sm text-gray-600 font-medium">Tersedia</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-lg"></div>
                    <span className="text-xs sm:text-sm text-gray-600 font-medium">Dipilih</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gray-300 rounded-lg"></div>
                    <span className="text-xs sm:text-sm text-gray-600 font-medium">Terisi</span>
                  </div>
                </div>
                ...
                {slotsLoading ? (
                  <div className="flex flex-col items-center justify-center py-8 sm:py-12">
                    ...
                    <p className="text-gray-500 text-sm sm:text-base">Memuat slot...</p>
                  </div>
                ) : (
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <div className="grid grid-cols-2 gap-3 sm:gap-4 text-center">
                    <div className="bg-green-50 rounded-lg p-3 sm:p-4">
                      <p className="text-xl sm:text-2xl font-bold text-green-600">{totalSlots - occupiedSlots.length}</p>
                      <p className="text-xs sm:text-sm text-green-700 font-medium">Slot Tersedia</p>
                    </div>
                    <div className="bg-red-50 rounded-lg p-3 sm:p-4">
                      <p className="text-xl sm:text-2xl font-bold text-red-600">{occupiedSlots.length}</p>
                      <p className="text-xs sm:text-sm text-red-700 font-medium">Slot Terisi</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                  ...
                  <div className="space-y-1 sm:space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none text-gray-900 placeholder-gray-400 text-sm sm:text-base"
                      required
                    />
                  </div>
                    ...
                    {fotoUrl && (
                      <div className="mt-4 relative group">
                        ...
                        <button
                          ...
                          className="absolute top-2 right-2 bg-red-500 hover:bg-red-600 text-white p-1 sm:p-2 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity"
                        >
                  ...
                  <div className="pt-4">
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 disabled:from-gray-400 disabled:to-gray-500 text-white font-bold py-3 sm:py-4 px-4 sm:px-6 rounded-xl shadow-lg hover:shadow-xl transform transition-all duration-200 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center space-x-2 sm:space-x-3 text-sm sm:text-base"
                    >
                      {loading ? (
                        <>
                    ...
                    {!slot && (
                      <p className="text-center text-xs sm:text-sm text-red-600 mt-2 font-medium">
      ...
      {showSuccessNotif && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fadeIn">
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl max-w-md w-full overflow-hidden animate-scaleIn">
            <div className="relative bg-gradient-to-r from-green-500 to-emerald-600 px-6 sm:px-8 py-6">
              ...
              <div className="flex items-center space-x-3">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-white">Berhasil Disimpan!</h3>
              </div>
            </div>
            ...
            <div className="p-4 sm:p-6 md:p-8">
              <div className="text-center mb-4 sm:mb-6">
                ...
                <p className="text-gray-500 text-xs sm:text-sm">Notifikasi telah dikirim via WhatsApp</p>
              </div>
              ...
              <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                <div className="flex items-center justify-between p-3 sm:p-4 bg-purple-50 rounded-xl border border-purple-100">
                  ...
                  <span className="text-xl sm:text-2xl font-bold text-purple-600">{successData.slot}</span>
                </div>
                ...
                <div className="flex items-center justify-between p-3 sm:p-4 bg-blue-50 rounded-xl border border-blue-100">
                  ...
                  <span className="text-lg sm:text-xl font-bold text-blue-600 tracking-wider">{successData.kode}</span>
                </div>
              </div>
