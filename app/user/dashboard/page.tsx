          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center space-x-2 min-w-0 flex-1">
              ...
              <div className="flex-1 min-w-0">
                <h1 className="text-sm sm:text-xl md:text-2xl font-bold text-gray-800 truncate">
                  Penitipan Barang
                </h1>
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className="flex items-center p-1.5 sm:p-2 sm:px-4 sm:py-2 bg-red-50 hover:bg-red-100 text-red-600 rounded-lg transition-colors duration-200 font-medium text-xs sm:text-base whitespace-nowrap"
                title="Logout"
              >
                <svg
                      ...
                      >
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
                          <div className="flex items-center space-x-3">
                            ...
                            <div className="flex-1 min-w-0">
                              <p className="text-base sm:text-lg font-bold text-gray-800 mb-1 truncate">
                                {b.nama_pemilik}
                              </p>
