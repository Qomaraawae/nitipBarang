...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div className="container mx-auto px-4 py-3 sm:px-6 sm:py-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-lg flex items-center justify-center shadow-lg flex-shrink-0">
            ...
            <div className="flex items-center justify-between sm:justify-end space-x-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="flex items-center space-x-2 px-3 py-2 sm:px-4 sm:py-2 bg-red-50 hover:bg-red-100 text-red-600 rounded-lg transition-colors duration-200 font-medium text-sm sm:text-base whitespace-nowrap"
                  title="Logout"
                >
      ...
      {/* Main Content - Kode lainnya tetap sama */}
      <div className="container mx-auto px-4 py-6 sm:px-6 sm:py-8">
        {isAdmin ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
            <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-md border border-gray-100 hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm font-medium text-gray-500 mb-1">Total Barang</p>
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-md border border-gray-100 hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm font-medium text-gray-500 mb-1">Slot Terisi</p>
                  <p className="text-2xl sm:text-3xl font-bold text-gray-800">
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-md border border-gray-100 hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm font-medium text-gray-500 mb-1">Slot Kosong</p>
                  <p className="text-2xl sm:text-3xl font-bold text-gray-800">
          ...
          <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-xl sm:rounded-2xl shadow-lg border border-blue-100 overflow-hidden mb-6 sm:mb-8">
            <div className="p-6 sm:p-8 md:p-12">
              <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg flex-shrink-0 mx-auto sm:mx-0">
                ...
                <div className="flex-1 text-center sm:text-left">
                  ...
                  <p className="text-sm sm:text-base md:text-lg text-gray-600 leading-relaxed">
                    ...
                    <span className="font-bold text-blue-600">"Titip Barang"</span> di bawah ini.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mb-6 sm:mb-8">
          {isAdmin ? (
            ...
            <>
              ...
              >
                ...
                <div className="relative px-4 py-3 sm:px-6 sm:py-4 flex items-center space-x-2 sm:space-x-3">
                  ...
                  <div className="text-left flex-1 min-w-0">
                    <span className="block text-sm sm:text-lg font-bold truncate">TITIP BARANG</span>
                    <p className="text-blue-100 text-xs truncate">Tambah barang baru</p>
                  </div>
                </div>
              </Link>
              ...
              >
                ...
                <div className="relative px-4 py-3 sm:px-6 sm:py-4 flex items-center space-x-2 sm:space-x-3">
                  ...
                  <div className="text-left flex-1 min-w-0">
                    <span className="block text-sm sm:text-lg font-bold truncate">AMBIL BARANG</span>
                    <p className="text-green-100 text-xs truncate">Proses pengambilan</p>
                  </div>
                </div>
              </Link>
              ...
              >
                ...
                <div className="relative px-4 py-3 sm:px-6 sm:py-4 flex items-center space-x-2 sm:space-x-3">
                  ...
                  <div className="text-left flex-1 min-w-0">
                    <span className="block text-sm sm:text-lg font-bold truncate">HISTORI</span>
                    <p className="text-purple-100 text-xs truncate">Riwayat aktivitas</p>
                  </div>
                </div>
              </Link>
            </>
            ...
            <Link 
              href="/titip" 
              className="group relative overflow-hidden bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-lg sm:rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02] w-full max-w-[500px]"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-blue-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <div className="relative px-4 py-4 sm:px-8 sm:py-6 flex items-center justify-center sm:justify-start space-x-3 sm:space-x-4">
                ...
                <div className="text-left">
                  <span className="block text-lg sm:text-xl md:text-2xl font-bold">TITIP BARANG</span>
                  <p className="text-blue-100 text-sm hidden sm:block">Titipkan barang Anda sekarang</p>
                </div>
              </div>
            </Link>
          )}
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-md border border-gray-100 overflow-hidden">
          <div className="px-4 py-4 sm:px-6 sm:py-5 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
              ...
              <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs sm:text-sm font-semibold whitespace-nowrap">
                {dataLoading ? "..." : isAdmin ? `${barang.length} Items` : `${userBarang.length} Items`}
              </span>
            </div>
          </div>
          ...
          <div className="p-4 sm:p-6">
            {dataLoading ? (
              <div className="flex flex-col items-center justify-center py-8 sm:py-12">
                ...
                <p className="text-gray-500 text-sm sm:text-base">Memuat data dari Firebase...</p>
              </div>
            ) : (() => {
              ...
              return displayBarang.length === 0 ? (
                ...
                <div className="space-y-3">
                  {displayBarang.map((b: Barang) => (
                    <div
                      key={b.id}
                      className="group bg-gradient-to-r from-gray-50 to-white hover:from-blue-50 hover:to-indigo-50 border border-gray-200 hover:border-blue-300 rounded-lg sm:rounded-xl p-3 sm:p-5 transition-all duration-300 hover:shadow-md"
                    >
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="text-base sm:text-lg font-bold text-gray-800 mb-1 truncate">{b.nama_pemilik}</p>
                        ...
                        <Link 
                          ...
                          className="flex items-center justify-center sm:justify-start space-x-2 px-3 py-2 sm:px-4 sm:py-2 bg-blue-50 group-hover:bg-blue-100 text-blue-600 rounded-lg transition-colors duration-200 font-medium text-sm sm:text-base whitespace-nowrap"
                        >
                          <span>Detail</span>
